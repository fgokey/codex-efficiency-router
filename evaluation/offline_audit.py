...
def quality_mutation_checks() -> list[dict]:
    ...
    mutations = [
        ...
        ('ignore_parent_validation', 'if set(final_review.validated_requirements) != set(contract.required):', 'if False:'),
        ('ignore_parent_findings', 'if final_review.open_blocking_findings:', 'if False:'),
